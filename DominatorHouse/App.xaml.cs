...
namespace Socinator
{
    ...
    public partial class App : PrismApplication
    {
        ...
        protected override Window CreateShell()
        {
            ...
            MahApps.Metro.ThemeManager.AddAccent("PrussianBlue", new Uri($"pack://application:,,,/LegionUIUtility;component/Themes/PrussianBlue.xaml"));
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            if (IsAlreadyRunning())
            {
                MessageBox.Show("LangKeyLegionAlreadyRunning".FromResourceDictionary(), "LangKeyWarning".FromResourceDictionary(), MessageBoxButton.OK, MessageBoxImage.Warning);
                Environment.Exit(0);
            }
