...
namespace EmbeddedBrowser.BrowserHelper
{
    public class RequestHandlerCustom : IRequestHandler
    {
        ...
        public RequestHandlerCustom(BrowserWindow embedBrowser, bool isNeedResourceData = false, DominatorHouseCore.Enums.SocialNetworks sn = DominatorHouseCore.Enums.SocialNetworks.Admin)
        {
