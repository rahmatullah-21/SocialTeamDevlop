...
namespace DominatorUIUtility.Navigations
{
    /// <summary>
    ...
    {
        private static ScreenTipRun theCurrentTourRun = null;
        ...
        internal static Func<ScreenTipRun, TourViewModel> ViewModelFactoryMethod { get; private set; }
        ...
        /// </param>
        public static void SetViewModelFactoryMethod(Func<IScreenTipRun, TourViewModel> factoryMethod)
        {
        ...
        internal static void SetTourRun(ScreenTipRun run)
        {
            var currentRun = theCurrentTourRun;
            currentRun?.Close();
