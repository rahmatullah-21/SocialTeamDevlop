...
namespace DominatorUIUtility.ScreenTip.ScreenTipMode
{
    public interface IScreenTipRun
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    class ScreenTipRun : IScreenTipRun
    {
        private readonly ScreenInfo myTour;
        ...
        private ScreenInfo toolTip;
        private IVisualElementManager visualElementManager;
        private IWindowManager windowManager;
        private IPopupNavigator popupNavigator;
        ...
        internal ScreenTipRun(ScreenInfo tour, IVisualElementManager visualElementManager, IWindowManager windowManager, IPopupNavigator popupNavigator)
        {
