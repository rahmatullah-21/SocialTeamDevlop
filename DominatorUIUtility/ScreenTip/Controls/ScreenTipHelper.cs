...
namespace DominatorUIUtility.Controls
{
  public static class ScreenTipHelper
    {
        ...
        public static readonly DependencyProperty ElementIDProperty =
            DependencyProperty.RegisterAttached("ElementID", typeof(string), typeof(ScreenTipHelper),
        ...
        public static readonly DependencyProperty PlacementProperty =
            DependencyProperty.RegisterAttached("Placement", typeof(Placement), typeof(ScreenTipHelper), new PropertyMetadata(Placement.TopLeft, (s, e) =>
            {
        ...
        public static readonly DependencyProperty WindowTransisionBehaviorProperty =
            DependencyProperty.RegisterAttached("WindowTransisionBehavior", typeof(WindowTransisionBehavior), typeof(ScreenTipHelper), new PropertyMetadata(WindowTransisionBehavior.Automatic, (s, e) =>
            {
                var element = s as UIElement;
