...
namespace LegionUIUtility.ViewModel.OtherConfigurations
{
    public class PinterestOtherConfigViewModel : BaseTabViewModel, IOtherConfigurationViewModel
    {
        ...
        public PinterestOtherConfigViewModel(IGenericFileManager genericFileManager) : base("LangKeyPinterest", "PinterestControlTemplate")
        {
            _genericFileManager = genericFileManager;
            SaveCmd = new DelegateCommand(Save);
            PinterestOtherConfigModel =
                _genericFileManager.GetModel<PinterestOtherConfigModel>(ConstantVariable.GetOtherPinterestSettingsFile()) ??
