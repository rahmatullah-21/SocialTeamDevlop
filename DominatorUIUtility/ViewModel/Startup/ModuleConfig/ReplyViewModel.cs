...
namespace DominatorUIUtility.ViewModel.Startup.ModuleConfig
{
    ...
    public class ReplyViewModel : StartupBaseViewModel, IReplyViewModel
    {
        ...
        {
            get { return _manageCommentModel; }
            set
            {
            ...
            try
            {
                ...
                if (!isContain)
                {
                    LstManageCommentModel.Add(new ManageCommentModel
                    {
                        ...
                        SelectedQuery = new ObservableCollection<QueryContent>(ManageComment.LstQueries.Where(x => x.IsContentSelected && x.Content.QueryType != "All" && x.Content.QueryValue != "All").ToList()),
