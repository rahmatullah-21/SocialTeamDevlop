...
namespace DominatorHouseCore.FileManagers
{
    ...
    public class AccountsFileManager : IAccountsFileManager
    {
        ...
        public void SaveAll(List<DominatorAccountModel> lstAccountModel)
        {
            // Warning: make sure lstAccountModel contains all accounts            
            _accountsCacheService.UpsertAccounts(lstAccountModel.ToArray());
        ...
        // backward compatibility for TD, PD
        public bool Add<AModel>(AModel account) where AModel : class
        {
            throw new Exception("this method should be deleted");
            //return BinFileHelper.Append(account);
        }

        public void DeleteSelected(List<DominatorAccountModel> accs)
        {
            _accountsCacheService.Delete(accs.ToArray());
        }
        ...
        public DominatorAccountModel GetAccount(string userName)
        {
            var accounts = GetAll();
