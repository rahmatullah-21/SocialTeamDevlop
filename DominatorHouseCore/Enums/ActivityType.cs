...
namespace DominatorHouseCore.Enums
{
    public enum ActivityType
    {
        ...
        [Description("Twitter,Instagram")] Repost = 8,
        ...
        [Description("Twitter,Instagram")] DownloadScraper = 12,
        ...
        [Description("Quora")] VoteAnswers = 17,

        [Description("Quora")] DownvoteAnswers = 18,

        [Description("Quora")] ReportQuestions = 19,
        ...
        [Description("Facebook")] CancelSentRequest = 25,
        ...
        [Description("Facebook")] CommentScraper = 29,

        [Description("Facebook,Gplus")] PostScraper = 30,

        [Description("Facebook,LinkedIn")] GroupJoiner = 31,

        [Description("Facebook,LinkedIn")] GroupUnJoiner = 32,
        ...
        [Description("Facebook")] GroupCreator = 37,
        ...
        [Description("Gplus")] Join = 43,

        [Description("Gplus")] Unjoin = 44,

        [Description("Facebook")] PostLikerCommentor = 45,

        [Description("Facebook")] FanpageLiker = 46,

        [Description("Facebook")] WebpageLikerCommentor = 47,
        ...
        [Description("YouTube")] Subscribe = 51,

        [Description("Facebook,Youtube")] Share = 52,

        //[Description("YouTube")]
        //LikeComments = 53,

        [Description("YouTube")] UnSubscribe = 54,

        [Description("YouTube")] ViewIncreaser = 55,

        [Description("Instagram")] BlockFollower = 56,

        [Description("Instagram,Youtube")] LikeComment = 57,

        [Description("Instagram")] HashtagsScraper = 58,
        ...
        [Description("Twitter")] DeleteTweet = 61,

        [Description("Twitter")] Mute = 62,

        [Description("Gplus")] CommunityScraper = 63,

        [Description("LinkedIn")] JobScraper = 64,

        [Description("LinkedIn")] CompanyScraper = 65,

        [Description("LinkedIn")] GroupMemberScraper = 66,

        [Description("LinkedIn")] SalesNavigatorUserScraper = 67,

        [Description("Youtube")] ChannelScraper = 68,

        [Description("Youtube")] Unsubscribe = 69,
        ...
        [Description("Youtube")] DislikeToComment = 77,

        [Description("Youtube")] ReplyToComment = 78,
        ...
        [Description("Twitter,Reddit")] Reply = 84,

        [Description("Reddit")] Delete = 85,
        ...
        [Description("Reddit")] SubredditScraper = 89,
