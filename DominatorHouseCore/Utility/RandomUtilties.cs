    ...
    public static class RandomUtilties
    {
        ...
        public static string GetRandomString(int outputStringLength)
        {
            ...
            return new string
                ...
                Select<string, char>((Func<string, char>)(s => s[ObjRandom.Next(s.Length)])).
                ToArray<char>());
        }
        ...
        {
            return new string(Enumerable.Repeat<string>("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", length).Select<string, char>((Func<string, char>)(s => s[ObjRandom.Next(s.Length)])).ToArray<char>());
        }
