        ...
        public AccountGrowthPropertiesProvider()
        {
            _growthProperties = new Dictionary<SocialNetworks, List<GrowthProperty>>
            {
                ...
                },
                {
                    ...
                    {
                        new GrowthProperty {PropertyName = "LangKeyFriends".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyJoinedGroups".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyOwnPages".FromResourceDictionary(), PropertyValue = 0},
                    }
                },
                {
                ...
                },
                {
                    SocialNetworks.Reddit, new List<GrowthProperty>
                    {
                        ...
                        new GrowthProperty {PropertyName = "LangKeyCommunities".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyPostKarma".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyCommentKarma".FromResourceDictionary(), PropertyValue = 0},
                    }
                }
               // {
               ...
               // }
                ,
                {
                    ...
                    {
                        new GrowthProperty {PropertyName = "LangKeyChannelsCount".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyViewsCount".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeySupportLinksCount".FromResourceDictionary(), PropertyValue = 0},
                    }
                },
                {
                ...
                },
                {
                    ...
                    {
                        new GrowthProperty {PropertyName = "LangKeyConnections".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyGroups".FromResourceDictionary(), PropertyValue = 0},
                        new GrowthProperty {PropertyName = "LangKeyInvitation".FromResourceDictionary(), PropertyValue = 0},
                    }
                },
                {
                    SocialNetworks.Tumblr, new List<GrowthProperty>
                    {
                        ...
                        new GrowthProperty {PropertyName = "LangKeyChannels".FromResourceDictionary(), PropertyValue = 0},
                    }
                },
                {
