...
namespace DominatorHouseCore.Utility
{
    public static class ConstantVariable
    {
        ...
        public static string UpdateVersionFilePath { get; set; } = "GramBoard/GramBoard.txt";

        public static string UpdateInstallerFilePath { get; set; } = "GramBoard/GramBoard.msi";
