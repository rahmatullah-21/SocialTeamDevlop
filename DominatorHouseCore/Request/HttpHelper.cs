...
namespace DominatorHouseCore.Request
{
    ...
    public class HttpHelperAsync : IHttpHelperAsync
    {
        ...
        public HttpHelperAsync(IRequestParameters requestParameters)
        {
            // set the web header details      
            SetRequestParameter(requestParameters);
            Request = _request;
        ...
        public virtual async Task WritePostDataAsync(HttpWebRequest webRequest, string postData)
        {
            ...
            {
                var postBuffer = Encoding.UTF8.GetBytes(postData);
                await WritePostDataAsync(webRequest, postBuffer);
            }
            catch (Exception ex)
            {
                ex.DebugLog();
        ...
        public virtual async Task WritePostDataAsync(HttpWebRequest webRequest, byte[] postBuffer)
        {
            try
            {
                webRequest.Method = "POST";
                webRequest.ContentLength = postBuffer.Length;
                using (var postDataStream = await webRequest.GetRequestStreamAsync())
                {
                    await postDataStream.WriteAsync(postBuffer, 0, postBuffer.Length);
                }
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns><see cref="IResponseParameter"/></returns>
        public async Task<IResponseParameter> GetFinalResponseAsync()
        {
            return await DoGetFinalResponseAsync();
        }

        public async Task<IResponseParameter> DoGetFinalResponseAsync(Func<bool> wasCancelled = null)
        {
            try
            {
                return await GetReponseAsync((HttpWebResponse)await _request.GetResponseAsync());
            }
            catch (WebException ex)
            {
                if (wasCancelled != null && wasCancelled())
                ...
                try
                {
                    // Get error message from the response
                    return ex.Response != null
                        ? await GetReponseAsync((HttpWebResponse)ex.Response)
                        : new ResponseParameter
                        {
                            HasError = true,
                            Exception = ex
        ...
        public async Task<IResponseParameter> GetFinalResponseAsync(CancellationToken cancellationToken)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<IResponseParameter> GetReponseAsync(HttpWebResponse webResponse)
        {
            // pointing same address Response and webResponse
            Response = webResponse;
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<IResponseParameter> GetRequestAsync(string url, CancellationToken cancellationToken)
        {
            try
            {
                _request = (HttpWebRequest)WebRequest.Create(url);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public Task<IResponseParameter> GetRequestAsync(string url, IRequestParameters requestParameters, CancellationToken cancellationToken)
        {
            _request = (HttpWebRequest)WebRequest.Create(url);
            SetRequestParametersToWebRequest(ref _request, requestParameters);
            return GetFinalResponseAsync(cancellationToken);
        ...
        public async Task<IResponseParameter> PostRequestAsync(string url, byte[] postData, CancellationToken cancellationToken)
        {
            _request = (HttpWebRequest)WebRequest.Create(url);
            SetRequestParametersToWebRequest(ref _request, RequestParameters);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<IResponseParameter> PostRequestAsync(string url, string postData, CancellationToken cancellationToken)
        {
            _request = (HttpWebRequest)WebRequest.Create(url);
            _request.Host = _request.RequestUri.Host;
            Response = null;
        ...
        /// <param name="requestParameters"></param>
        /// <returns></returns>
        public async Task<IResponseParameter> PostRequestAsync(string url, string postData, IRequestParameters requestParameters)
        {
            _request = (HttpWebRequest)WebRequest.Create(url);
            Response = null;
            SetRequestParametersToWebRequest(ref _request, requestParameters);
            await WritePostDataAsync(_request, postData);
            var response = await GetFinalResponseAsync(default(CancellationToken));
            return response;
        }
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        public async Task<IResponseParameter> PostRequestAsync(string url, string postData, IRequestParameters requestParamater, CancellationToken cancellationToken)
        {
            _request = (HttpWebRequest)WebRequest.Create(url);
            _request.Host = _request.RequestUri.Host;
            SetRequestParametersToWebRequest(ref _request, requestParamater);
        ...
        public async Task<IResponseParameter> GetApiRequest(string url)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            using (HttpWebResponse response = (HttpWebResponse)await request.GetResponseAsync())
        ...
        public async Task<IResponseParameter> PostApiRequest(string url, byte[] postData)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Host = "api.socinator.com";
        ...
        public async Task<IResponseParameter> PostApiRequest(string url, string postData)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Host = "api.socinator.com";
            ...
            using (var postDataStream = await request.GetRequestStreamAsync())
            {
                await postDataStream.WriteAsync(postDataBytes, 0, postDataBytes.Length);
            }
        ...
        public async Task<IResponseParameter> PostApiRequestAsync(string url, string postData)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Host = "api.socinator.com";
        ...
        public async Task<IResponseParameter> GetApiRequestAsync(string url)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "GET";
            using (HttpWebResponse response = (HttpWebResponse)await request.GetResponseAsync())
        ...
        public async Task<IResponseParameter> PostApiRequestAsync(string url, byte[] postData)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
            request.Host = "api.socinator.com";
