        ...
        public DbOperations(string id, SocialNetworks networks, string type)
        {
            ...
            if (type == ConstantVariable.GetAccountDb)
            {
                var databaseConnection =
                    ServiceLocator.Current.GetInstance<IAccountDatabaseConnection>(networks.ToString());
            ...
            {
                var databaseConnection =
                    ServiceLocator.Current.GetInstance<ICampaignDatabaseConnection>(networks.ToString());
                _context = databaseConnection.GetSqlConnection(id);
            }
