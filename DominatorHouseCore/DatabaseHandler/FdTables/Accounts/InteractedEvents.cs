...
namespace DominatorHouseCore.DatabaseHandler.FdTables.Accounts
{
    public class InteractedEvents
    {
        ...
        public string IsGuestCanInviteFriends { get; set; }
        ...
        public string IsShowGuestList { get; set; }

        /// <summary>
        /// Describes AnyOneCanPostForReportedPost return bool
        /// </summary>
        [System.ComponentModel.DataAnnotations.Schema.Column(Order = 16)]
        public string IsAnyOneCanPostForReportedPost { get; set; }

        /// <summary>
        /// Describes AnyOneCanPostForAllPost return bool
        /// </summary>
        [System.ComponentModel.DataAnnotations.Schema.Column(Order = 17)]
        public string IsAnyOneCanPostForAllPost { get; set; }

        /// <summary>
        /// Describes IsReportedPost return bool
        /// </summary>
        [System.ComponentModel.DataAnnotations.Schema.Column(Order = 18)]
        public string IsAllPost { get; set; }
