...
namespace DominatorHouseCore.Models
{
    ...
    {
        ObservableCollection<EachNetworkActivityCustomizeModel> _networksActListCollection;
        [ProtoMember(1)]
    ...
    public class EachNetworkActivityCustomizeModel : BindableBase
    {
        ...
        ObservableCollection<NetworkCustomizeActivityTypeModel> _networkActivityTypeModelCollections = new ObservableCollection<NetworkCustomizeActivityTypeModel>();
        [ProtoMember(2)]
        public ObservableCollection<NetworkCustomizeActivityTypeModel> NetworkActivityTypeModelCollections
        {
            ...
            set
            {
                SetProperty(ref _networkActivityTypeModelCollections, value);
            }
        }
    }
