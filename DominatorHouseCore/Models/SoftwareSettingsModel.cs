...
namespace DominatorHouseCore.Models
{
    ...
    public class SoftwareSettingsModel : BindableBase
    {
        ...
        private bool _isLikeCountChkd;

        [ProtoMember(47)]
        public bool IsLikeCountChkd
        {
            get
            {
                return _isLikeCountChkd;
            }
            set
            {
                if (value == _isLikeCountChkd)
                    return;
                SetProperty(ref _isLikeCountChkd, value);
            }
        }


        private RangeUtilities _postLikerCount = new RangeUtilities(6, 8);
        ...
        public RangeUtilities PostLikerCount
        {
            ...
            set
            {
                if (value == _postLikerCount) return;
                SetProperty(ref _postLikerCount, value);
            }
        }


        private bool _isWatchCountChkd;

        [ProtoMember(49)]
        public bool IsWatchCountChkd
        {
            get
            {
                return _isWatchCountChkd;
            }
            set
            {
                if (value == _isWatchCountChkd)
                    return;
                SetProperty(ref _isWatchCountChkd, value);
            }
        }


        private RangeUtilities _watchVideoCount = new RangeUtilities(6, 8);

        [ProtoMember(50)]
        public RangeUtilities WatchVideoCount
        {
            get
            {
                return _watchVideoCount;
            }
            set
            {
                if (value == _watchVideoCount) return;
                SetProperty(ref _watchVideoCount, value);
            }
        }
    }
}
